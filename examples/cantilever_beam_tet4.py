# Example: cantilever beam solved with Tet4 solid elements.

from pathlib import Path

from fem.mesh_io import read_tet4_3d_abaqus
from fem.stiffness import compute_tet4_element_stiffness
...
from fem.post import (
    ...
    export_tet4_element_stress_csv,
    export_tet4_nodal_stress_csv,
...
mesh = read_tet4_3d_abaqus(
    inp_path=r"examples\cantilever_beam_tet4.inp",
...
K = assemble_global_stiffness_sparse(
    ...
    compute_element_stiffness=lambda eid: compute_tet4_element_stiffness(
        mesh,
        mesh.elements[eid],
...
disp_csv_path = results_dir / "cantilever_beam_tet4_nodal_displacements.csv"
elem_csv_path = results_dir / "cantilever_beam_tet4_element_stress.csv"
nodal_stress_csv_path = results_dir / "cantilever_beam_tet4_nodal_stress.csv"
vtk_path = results_dir / "cantilever_beam_tet4.vtk"
